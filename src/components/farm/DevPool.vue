  ...
  <!-- <b-button block variant="outline-primary" @click="emergencyWithdraw">紧急退出</b-button> -->
    <div class="delegate">
      ...
      <div class="delegatetext round-box">
          ...
          DEV总存量： {{ balanceOfTotalLp }} DEV<br>
  ...
  export default {
    ...
    methods: {
      ...
      async getBalanceAndAllowance(){
				...
				let lpInstance = new this.web4.eth.Contract(abi, this.devPoolToken)
      ...
      async letApprove(){
        ...
        this.isLoading = true
				let abi = this.$store.state.ercAbi
				let lpInstance = new this.web3.eth.Contract(abi, this.devPoolToken)
